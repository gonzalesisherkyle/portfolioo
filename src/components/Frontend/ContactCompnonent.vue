        ...
        <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
          <div class="mb-12 max-w-[570px] lg:mb-0">
            ...
            <p class="text-body-color mb-9 text-base leading-relaxed">
              Contact me if you have any questions, need extra information, or setup a meeting time.
            </p>
            <div class="mb-8 flex w-full max-w-[370px]">
              ...
              <div class="w-full">
                ...
                <p class="text-body-color text-base">Pateros, Metro Manila</p>
              </div>
            </div>
            <div class="mb-8 flex w-full max-w-[370px]">
              <div
              ...
              <div class="w-full">
                ...
                <p class="text-body-color text-base">(+63)963 179 3000</p>
              </div>
            </div>
            <div class="mb-8 flex w-full max-w-[370px]">
              <div
              ...
              <div class="w-full">
                ...
                <p class="text-body-color text-base">gonzalesisherkyle1@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
        <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
          <div class="relative rounded-lg bg-light-primary dark:bg-dark-primary p-8 sm:p-12">
            <form action="https://formspree.io/f/mrgwoqdb" method="POST" name="contact">
              ...
              ></div>
              <div class="relative z-0 w-full mb-6 group">
                <button class="main text-dark-primary" type="submit">Send</button>
              </div>
            </form>
            <div>
